...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRGeneralSettings_OnDisable_mDF590AD0070FA5C205F565A1390C5FD3B04C0636 (XRGeneralSettings_t32A12852D8662239F55902E9FD6A299201C04042 * __this, const RuntimeMethod* method);
...
IL_0010:
	{
		...
		NullCheck(L_3);
		XRGeneralSettings_OnDisable_mDF590AD0070FA5C205F565A1390C5FD3B04C0636(L_3, /*hidden argument*/NULL);
		// instance.OnDestroy();
		XRGeneralSettings_t32A12852D8662239F55902E9FD6A299201C04042 * L_4 = V_0;
		NullCheck(L_4);
		XRGeneralSettings_OnDestroy_mADCE8F90BABF1629E10E8BCF6FA19388C169A430(L_4, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRGeneralSettings_OnDisable_mDF590AD0070FA5C205F565A1390C5FD3B04C0636 (XRGeneralSettings_t32A12852D8662239F55902E9FD6A299201C04042 * __this, const RuntimeMethod* method)
{
	{
		// StopXRSDK();
		XRGeneralSettings_StopXRSDK_m5972F9B13CAF086DE0CCFD19E1D84C0D98EEDE9A(__this, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRLoaderHelper__ctor_mD27E0396EC4B11E208CF891642475B496CADAC9B (XRLoaderHelper_t37A55C343AC31D25BB3EBD203DABFA357F51C013 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (NULL, XRLoaderHelper__ctor_mD27E0396EC4B11E208CF891642475B496CADAC9B_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
...
IL_0038:
		{
			...
			NullCheck(L_7);
			bool L_8;
			L_8 = VirtFuncInvoker0< bool >::Invoke(4 /* System.Boolean UnityEngine.XR.Management.XRLoader::Initialize() */, L_7);
			if (!L_8)
			{
				goto IL_0050;
			}
...
IL_0040:
		{
			...
			XRManagerSettings_set_activeLoader_m77ACE8749C38314C5DA2A6A4F6551DDBC552EC72(__this, L_9, /*hidden argument*/NULL);
...
IL_0075:
		{
			// if (loader.Initialize())
			XRLoader_tE37B92C6B9CDD944DDF7AFF5704E9EB342D62F6B * L_14 = V_3;
			NullCheck(L_14);
			bool L_15;
			L_15 = VirtFuncInvoker0< bool >::Invoke(4 /* System.Boolean UnityEngine.XR.Management.XRLoader::Initialize() */, L_14);
			if (!L_15)
			{
				goto IL_008f;
			}
...
IL_007d:
		{
			// activeLoader = loader;
			XRManagerSettings_t8F274E413BAFFBB547DAD1B7E50EDD9D7B16E19F * L_16 = V_2;
			XRLoader_tE37B92C6B9CDD944DDF7AFF5704E9EB342D62F6B * L_17 = V_3;
			NullCheck(L_16);
			XRManagerSettings_set_activeLoader_m77ACE8749C38314C5DA2A6A4F6551DDBC552EC72(L_16, L_17, /*hidden argument*/NULL);
			// m_InitializationComplete = true;
			XRManagerSettings_t8F274E413BAFFBB547DAD1B7E50EDD9D7B16E19F * L_18 = V_2;
			NullCheck(L_18);
...
IL_00a9:
		{
			// foreach (var loader in loaders)
			Enumerator_t5E925E051A8E0B9BEF75F1250A9B42E275E89FCF * L_19 = __this->get_address_of_U3CU3E7__wrap1_3();
			bool L_20;
			L_20 = Enumerator_MoveNext_m19D8DC887F99E56196FA26536373CE0E192D6741((Enumerator_t5E925E051A8E0B9BEF75F1250A9B42E275E89FCF *)L_19, /*hidden argument*/Enumerator_MoveNext_m19D8DC887F99E56196FA26536373CE0E192D6741_RuntimeMethod_var);
			if (L_20)
			{
				goto IL_0060;
			}
...
IL_00c6:
		{
			Enumerator_t5E925E051A8E0B9BEF75F1250A9B42E275E89FCF * L_21 = __this->get_address_of_U3CU3E7__wrap1_3();
			il2cpp_codegen_initobj(L_21, sizeof(Enumerator_t5E925E051A8E0B9BEF75F1250A9B42E275E89FCF ));
			// activeLoader = null;
			XRManagerSettings_t8F274E413BAFFBB547DAD1B7E50EDD9D7B16E19F * L_22 = V_2;
			NullCheck(L_22);
			XRManagerSettings_set_activeLoader_m77ACE8749C38314C5DA2A6A4F6551DDBC552EC72(L_22, (XRLoader_tE37B92C6B9CDD944DDF7AFF5704E9EB342D62F6B *)NULL, /*hidden argument*/NULL);
			// }
			V_0 = (bool)0;
			goto IL_00e4;
		}
